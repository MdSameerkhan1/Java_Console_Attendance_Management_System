...
public class CustomColor {
	  // public static final String RESET = "\033[0m"; // Text Reset
	   ...
	   // public static final String GREEN = "\u001B[32m";
	    ...
	    // Custom color for saffron
	    public static final String SAFFRON = "\u001B[38;5;208m";  // You may need to adjust the color code based on your preference

	    // Custom color for navy blue
	    public static final String NAVY_BLUE = "\u001B[38;5;18m";   // You may need to adjust the color code based on your preference
	    // Regular Colors
